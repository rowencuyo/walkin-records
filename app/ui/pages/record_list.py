...
class RecordCard(QFrame):
    ...
    def _setup_ui(self, record: WalkInRecord, pic_path: str | None,
        ...
        name_label.setStyleSheet("font-weight: 600; font-size: 16px; color: #1D1D1F; background: transparent;")
        name_label.setWordWrap(True)
        name_col.addWidget(name_label)

        passport_label = QLabel(record.passport_number)
        passport_label.setStyleSheet("font-size: 14px; color: #6E6E73; background: transparent;")
        ...
        for label_text, value in details:
            if value:
                ...
                lbl.setStyleSheet("font-size: 13px; color: #8E8E93; min-width: 40px; background: transparent;")
                row.addWidget(lbl)
                val = QLabel(value)
                val.setStyleSheet("font-size: 13px; color: #1D1D1F; background: transparent;")
